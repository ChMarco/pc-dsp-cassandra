...
backup() {
    ...
    rsync --delete -auve 'ssh -i /home/ubuntu/cassandra-poc-eu-west-1.pem' $path_to_backup.tar ubuntu@${backup_server}:${path_to_remote_backup}/`hostname -s`${today}.tar 1>$log 2>&1
